...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ninja_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("43d6905c-a154-5748-ac05-e201d127901c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ninja", artifacts_toml) for e in artifacts["ninja"]]
...
if best_platform === nothing
    @debug("Unable to load ninja; unsupported platform $(triplet(platform_key_abi()))")
else
